...
The methodology must itself be an example of the methodology.
...
1. The methodology has its own problem statement.
2. The methodology has its own assumptions.
3. The methodology has its own self-spec.
4. The methodology has its own refinement story.
5. Changes to the methodology should be justified within the methodology.
